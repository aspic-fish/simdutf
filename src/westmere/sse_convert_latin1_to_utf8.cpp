...
std::pair<const char* const, char* const> sse_convert_latin1_to_utf8(
  ...
  while (latin_input + 16 <= end) {
    ...
    latin_input += internal::westmere::write_v_u16_11bits_to_utf8(v_u16_latin_1_half, utf8_output);
    latin_input += internal::westmere::write_v_u16_11bits_to_utf8(v_u16_latin_2_half, utf8_output);
  }
